...
HGVSHash = {}
EPHash = {}
submitters = ['GenomeConnect_Association_for_Creatine_Defici', 
              'GenomeConnect_CFC_International',
              'GenomeConnect_ClinGen', 
              'GenomeConnect_CureCADASIL', 
              'GenomeConnect_No_Stomach_For_Cancer',
              'GenomeConnect_GM1',
              'GenomeConnect_Brain_Gene_Registry'
              'GenomeConnect_Invitae_Patient_Insights_Networ']
...
def main():
    ...
    inputFile1 = 'ClinVarVariationRelease_00-latest_weekly.xml.gz' #path: pub/clinvar/xml/clinvar_variation/
